...
<template>
    <CustomCard class="col-span-12 xl:col-span-6">
        <CustomCard.Header class="!max-h-none xl:flex-row flex-col !items-start xl:!items-center">
            <CustomCard.Title>Website Traffic Analytics</CustomCard.Title>
        ...
        <CustomCard.Content class="p-4">
            <LineChart class="min-h-72" :datasets="chartData" :tension="0.1" :showPoints="true" :showXBorder="true" :minY="2000" />
        </CustomCard.Content>
    </CustomCard>
</template>
