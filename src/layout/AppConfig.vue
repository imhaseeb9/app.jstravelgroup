...
const { layoutConfig, layoutState, changeMenuMode, isDarkTheme } = useLayout();
...
function applyTheme(type, color) {
    if (type === 'primary') {
        ...
        if (color.name === 'noir') document.documentElement.classList.add('p-noir');
        else document.documentElement.classList.remove('p-noir');
    } else if (type === 'surface') {
            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap">
                    <button
                        ...
                        class="w-6 h-6 cursor-pointer border border-surface hover:shadow-lg rounded duration-150 flex items-center justify-center"
